...
try {
    ...
    const regex = /alphainfra: \(\) => `[\s\S]*?`,\s*\/\/\s*MONITORING VIEW/;
    ...
    const replacement = `alphainfra: () => \`
                <div class="w-full h-full bg-white flex flex-col font-sans overflow-hidden fade-in relative">
                    <div id="alphainfra-full-messages" class="flex-1 overflow-y-auto chat-bubble-container scrollbar-hide pt-10 pb-40">
                        <div class="flex-1 flex flex-col items-center justify-center min-h-[60vh] px-8 max-w-3xl mx-auto space-y-12">
                            <div class="relative">
                    ...
                    <div class="absolute bottom-0 left-0 w-full flex justify-center pb-8 px-8 bg-gradient-to-t from-white via-white to-transparent pt-16 z-20 pointer-events-none">
                        <div class="w-full max-w-3xl flex flex-col gap-4 pointer-events-auto">
                             <div class="relative chat-input-focus-ring bg-gray-50 border border-gray-200 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-500 group focus-within:bg-white focus-within:shadow-[0_20px_50px_rgba(147,51,234,0.15)] focus-within:border-purple-300">
                             ...
                             <div class="flex items-center justify-between px-4">
                                 <div class="flex items-center gap-2">
                                     ...
                                     <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Synthesis Eng V4.0 Ready</span>
                                 </div>
                                 <div class="flex items-center gap-6">
                                     <button onclick="openAlphaInfraConfig()" class="flex items-center gap-2 cursor-pointer text-gray-400 hover:text-purple-600 transition-colors">
                                         ...
                                         <span class="text-[10px] font-bold uppercase tracking-widest">Configuration</span>
                                     </button>
                                     ...
                                     <button onclick="clearAlphaInfraChat()" class="flex items-center gap-2 cursor-pointer text-gray-400 hover:text-red-500 transition-colors">
                                         ...
                                         <span class="text-[10px] font-bold uppercase tracking-widest">Clear Chat</span>
                                     </button>
                                 </div>
                             </div>
                        </div>
    ...
    console.log("Successfully replaced alphainfra view!");
} catch (e) {
    console.error(e);
}
