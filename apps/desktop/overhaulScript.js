...
try {
    ...
    const replacement = `alphainfra: () => \`
                <div class="w-full flex-1 flex flex-col font-sans overflow-hidden fade-in relative bg-white md:rounded-[2.5rem] border border-gray-100 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.05)] mb-4">
    ...
    console.log("Successfully overhauled alphainfra view layout!");
} catch (e) {
    console.error(e);
}
